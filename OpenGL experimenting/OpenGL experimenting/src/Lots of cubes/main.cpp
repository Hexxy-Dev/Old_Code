...
std::uniform_real_distribution<float> unif(-2, 2);
...
Cube vertices[] =
{
	...
	Cube(1.1,0.0,0.0,0.5,1.0),
	Cube(2.2,0.0,0.0,0.5,1.0),

	Cube(0.0,1.1,0.0,0.5,1.0),
	Cube(1.1,1.1,0.0,0.5,1.0),
	Cube(2.2,1.1,0.0,0.5,1.0),

	Cube(0.0,2.2,0.0,0.5,1.0),
	Cube(1.1,2.2,0.0,0.5,1.0),
	Cube(2.2,2.2,0.0,0.5,1.0),


	Cube(0.0,0.0,1.1,0.5,1.0),
	Cube(1.1,0.0,1.1,0.5,1.0),
	Cube(2.2,0.0,1.1,0.5,1.0),

	Cube(0.0,1.1,1.1,0.5,1.0),
	//Cube(1.1,1.1,1.1,0.5,1.0),
	Cube(2.2,1.1,1.1,0.5,1.0),

	Cube(0.0,2.2,1.1,0.5,1.0),
	Cube(1.1,2.2,1.1,0.5,1.0),
	Cube(2.2,2.2,1.1,0.5,1.0),



	Cube(0.0,0.0,2.2,0.5,1.0),
	Cube(1.1,0.0,2.2,0.5,1.0),
	Cube(2.2,0.0,2.2,0.5,1.0),

	Cube(0.0,1.1,2.2,0.5,1.0),
	Cube(1.1,1.1,2.2,0.5,1.0),
	Cube(2.2,1.1,2.2,0.5,1.0),

	Cube(0.0,2.2,2.2,0.5,1.0),
	Cube(1.1,2.2,2.2,0.5,1.0),
	Cube(2.2,2.2,2.2,0.5,1.0)
};
...
void keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	{
		for (int i = 0; i < sizeof(vertices) / sizeof(Cube); i++)
		{
			float x = unif(rng);
			float y = unif(rng);
			float z = unif(rng);
			float scale = unif2(rng);
			vertices[i] = Cube(x, y, z, scale, 1.0);
		}
	}
...
glm::vec3 camera_position(0.5f, 1.0f, 5.0f);
