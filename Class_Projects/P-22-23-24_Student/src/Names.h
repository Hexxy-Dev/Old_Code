...
constexpr char* Male_Names[] = {
	"James", "Robert","John","Michael","William","David",
	...
	"Walter","Ethan","Jeremy","Harold","Keith","Christian",
...
constexpr char* Female_Names[] = {
	...
	"Grace","Denise","Amber","Marilyn","Beverly","Danielle",
	"Theresa","Sophia","Marie","Diana","Brittany","Natalie",
	"Isabella","Charlotte","Rose","Alexis","Kayla"
};

constexpr char* Surnames[] = {
	...
	"Ramos","Kim","Cox","Ward","Richardson","Watson","Brooks","Chavez","Wood",
	"James","Bennet","Gray","Mendoza","Ruiz","Hughes","Price","Alvarez",
	"Castillo","Sanders","Patel","Myers","Long","Ross","Foster","Jimenez"
};

constexpr char* const* Names[] = { Male_Names, Female_Names, Surnames };