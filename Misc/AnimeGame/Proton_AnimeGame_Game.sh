...
function main() {
    ...
    cd '/home/hexxy/.local/share/Steam/steamapps/compatdata/AnimeGame/pfx/drive_c/Program Files/Genshin Impact/Genshin Impact game'
    ...
    local binary="GenshinImpact.exe"
