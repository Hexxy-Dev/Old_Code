...
void normal_orientation(int i, int j, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
...
void mirror_on_vertical(int i, int j, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
    for (int k = 0; k < sprite_rez; k++) {
        for (int y = 0; y < sprite_rez; y++) {
...
// normal -> up -> right
void diagonal_right_flip(int i, int j, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
    for (int k = 0; k < sprite_rez; k++) {
        for (int y = 0; y < sprite_rez; y++) {
...
void rotate_right_90(int i, int j, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
    for (int k = 0; k < sprite_rez; k++) {
        for (int y = 0; y < sprite_rez; y++) {
...
void vertical_flip(int i, int j, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
...
// normal -> up -> left
void diagonal_left_flip(int i, int j, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
...
void place_piece(int i, int j, int orientation, int piece, int sprites[20][sprite_rez][sprite_rez], Hexxy::Data::array2D& full_map)
{
    switch (orientation) {
    case 0:
    case 1:
...
void mirror_map_vertical(Hexxy::Data::array2D& full_map)
{
